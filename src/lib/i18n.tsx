...
export const translations = {
    ...
    calculator: {
        tr: {
            revenue: 'Toplam Gelir (Net)',
            adSpend: 'Toplam Reklam Harcaması',
            cogs: 'Toplam Ürün Maliyeti (COGS)',
            shipping: 'Toplam Kargo Gideri',
            paymentFees: 'Toplam Ödeme Komisyonu',
            handling: 'Toplam Paketleme & Operasyon',
            channel: 'Kanal',
        ...
        en: {
            ...
            paymentFees: 'Total Payment Fees',
            handling: 'Total Packaging & Operations',
            channel: 'Channel',
            currency: 'Currency',
    ...
    chart: {
        tr: {
            ...
            fixedCosts: 'Toplam Sabit Giderler',
        },
        en: {
            ...
            operationCost: 'Packaging & Operations',
